...
<!-- various drop down menus for user to select from-->
		...
		<br><br>
		Oh Noes I can't find an agreement maybe i'll try this button 
		<button class='AddAgreement buttons' style='margin-right:25%'>Add Agreement</button>
		<br>
		...
		<input class="buttons" type="file" value "Select Image File"name="image"><br>
